...
too many results. The techniques in the former case may end up picking rare ``patterns'' if they have high confidence, and in the latter case only work for a restricted number of attributes (in their case, 4). \agp{check}
