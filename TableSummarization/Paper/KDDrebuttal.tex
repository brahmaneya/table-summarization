...
% `Formalizing Complex Prior Information to Quantify Subjective Interestingness of Frequent Pattern Sets' uses a max entropy based approach, instead of maximizing total coverage of the table. Similarly, `A framework for mining interesting pattern sets' also uses max entropy and focuses on presenting `surprising' information based on the user's prior probability distribution.
