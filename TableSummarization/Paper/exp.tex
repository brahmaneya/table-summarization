...
\agp{I propose using two sections: one is Qualitative Study, which will contain 4.2, 4.3, and 
Quantitiative Study, whcih will contain the rest of the sections.
For the quantitative study, mention that the goal of the experimental evaluation is to study
the impact of the two parameters on time and accuracy before you get into details.}

\agp{Additional experiments:
