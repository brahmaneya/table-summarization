...
\textbf{Note to Reviewers}: This paper is an extended version of the paper "Interactive Data Exploration with Smart Drill Down" that appeared in the 2016 IEEE International Conference on Data Engineering. This extended version contains about $30\%$ new material compared to the original version. In particular, the additions include:
...
\item We added Section~\ref{sec:extensions}, which contains two extensions, namely dealing with numerical attributes, and using aggregates other than Count. 
\end{enumerate}
